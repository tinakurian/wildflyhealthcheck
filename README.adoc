...
----
$ git clone git@github.com:tinakurian/wildflyhealthcheck

$ cd wildflyhealthcheck
...
== More Information
You can learn more about this booster and rest of the WildFly Swarm runtime in the link:http://launcher.fabric8.io/docs/wf-swarm-runtime.html[WildFly Swarm Runtime Guide].
